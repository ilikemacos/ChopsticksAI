...
Latest release: **cs.AI Online 4.0.7** (Offline remains 3.6.10).
...
[![Download cs.AI 4.0.7](https://img.shields.io/badge/download-cs.AI%204.0.7-00ff80)](https://chopstickshq.com/chopsticks-ai/online/)
...
Or download **chopsticksAI-v4.0.7.zip** / **chopsticksAI-offline-v3.6.10.zip** from the product pages or [Releases](https://github.com/ilikemacos/ChopsticksAI/releases).
