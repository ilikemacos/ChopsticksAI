...
Latest release: **cs.AI Online 3.8.2** (Offline remains 3.6.10).
...
[![Download cs.AI 3.8.2](https://img.shields.io/badge/download-cs.AI%203.8.2-00ff80)](https://chopstickshq.com/chopsticks-ai/online/)
...
- Create account emails a 6-digit code (10 minutes)
- Sign in stays email and password
...
Or download **chopsticksAI-v3.8.2.zip** / **chopsticksAI-offline-v3.6.10.zip** from the product pages or [Releases](https://github.com/ilikemacos/ChopsticksAI/releases).
