...
Latest release: **cs.AI Online 3.8.4** (Offline remains 3.6.10).
...
[![Download cs.AI 3.8.4](https://img.shields.io/badge/download-cs.AI%203.8.4-00ff80)](https://chopstickshq.com/chopsticks-ai/online/)
...
- Kaji no longer steals the rail when you switch to another tab
...
Or download **chopsticksAI-v3.8.4.zip** / **chopsticksAI-offline-v3.6.10.zip** from the product pages or [Releases](https://github.com/ilikemacos/ChopsticksAI/releases).
