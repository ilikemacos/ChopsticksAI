...
Latest release: **cs.AI Online 4.1c** (Offline remains 3.6.10).
...
[![Download cs.AI 4.1c](https://img.shields.io/badge/download-cs.AI%204.1c-00ff80)](https://chopstickshq.com/chopsticks-ai/online/)
...
Or download **chopsticksAI-v4.1c.zip** / **chopsticksAI-offline-v3.6.10.zip** from the product pages or [Releases](https://github.com/ilikemacos/ChopsticksAI/releases).
