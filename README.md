...
Latest release: **cs.AI Online 3.8.3** (Offline remains 3.6.10).
...
[![Download cs.AI 3.8.3](https://img.shields.io/badge/download-cs.AI%203.8.3-00ff80)](https://chopstickshq.com/chopsticks-ai/online/)
...
- Plans: 5 Fathom keys unlock csCode-Pro and Kaji; Free lists Sky plates
- Upgrades Create account uses the 6-digit email code
...
Or download **chopsticksAI-v3.8.3.zip** / **chopsticksAI-offline-v3.6.10.zip** from the product pages or [Releases](https://github.com/ilikemacos/ChopsticksAI/releases).
