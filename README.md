...
Latest release: **cs.AI Online 3.7.5a** (Offline remains 3.6.10).
...
[![Download cs.AI 3.7.5a](https://img.shields.io/badge/download-cs.AI%203.7.5a-00ff80)](https://chopstickshq.com/chopsticks-ai/online/)
...
## What's new in 3.7.5a

- No Keychain prompt — session and API keys stay in app defaults
- Intelligence stack from 3.7.5 (router, evidence, critic)
...
Or download **chopsticksAI-v3.7.5a.zip** / **chopsticksAI-offline-v3.6.10.zip** from the product pages or [Releases](https://github.com/ilikemacos/ChopsticksAI/releases).
