...
Latest release: **cs.AI Online 3.8.6** (Offline remains 3.6.10).
...
[![Download cs.AI 3.8.6](https://img.shields.io/badge/download-cs.AI%203.8.6-00ff80)](https://chopstickshq.com/chopsticks-ai/online/)
...
- Max mode: thinks harder, 1,000 tokens per request
...
Or download **chopsticksAI-v3.8.6.zip** / **chopsticksAI-offline-v3.6.10.zip** from the product pages or [Releases](https://github.com/ilikemacos/ChopsticksAI/releases).
