...
Latest release: **cs.AI Online 3.8.1** (Offline remains 3.6.10).
...
[![Download cs.AI 3.8.1](https://img.shields.io/badge/download-cs.AI%203.8.1-00ff80)](https://chopstickshq.com/chopsticks-ai/online/)
...
- Kaji Run / Don’t run on the Commands strip (no modal)
- Last command output on that strip; scratch folder opens in Finder
...
Or download **chopsticksAI-v3.8.1.zip** / **chopsticksAI-offline-v3.6.10.zip** from the product pages or [Releases](https://github.com/ilikemacos/ChopsticksAI/releases).
