...
Latest release: **cs.AI Online 3.8.7** (Offline remains 3.6.10).
...
[![Download cs.AI 3.8.7](https://img.shields.io/badge/download-cs.AI%203.8.7-00ff80)](https://chopstickshq.com/chopsticks-ai/online/)
...
- Max is in the Apps plate list, next to Kaji
...
Or download **chopsticksAI-v3.8.7.zip** / **chopsticksAI-offline-v3.6.10.zip** from the product pages or [Releases](https://github.com/ilikemacos/ChopsticksAI/releases).
