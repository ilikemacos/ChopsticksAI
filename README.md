...
Latest release: **cs.AI Online 3.7.5b** (Offline remains 3.6.10).
...
[![Download cs.AI 3.7.5b](https://img.shields.io/badge/download-cs.AI%203.7.5b-00ff80)](https://chopstickshq.com/chopsticks-ai/online/)
...
## What's new in 3.7.5b

- Kaji is an agent: GLM 5.2, North Mini Code, Nemotron 3 Ultra, Laguna S 2.1
- On Mac, Kaji can list, read, and write files in Home, Desktop, Documents, Downloads
...
Or download **chopsticksAI-v3.7.5b.zip** / **chopsticksAI-offline-v3.6.10.zip** from the product pages or [Releases](https://github.com/ilikemacos/ChopsticksAI/releases).
