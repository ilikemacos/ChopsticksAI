...
Latest release: **cs.AI Online 3.7.3** (Offline remains 3.6.10).
...
[![Download cs.AI 3.7.3](https://img.shields.io/badge/download-cs.AI%203.7.3-00ff80)](https://chopstickshq.com/chopsticks-ai/online/)
...
- Sign in is **email and password only** — no 6-digit email code
- Kaji remains alpha and prone to wrong answers
...
Or download **chopsticksAI-v3.7.3.zip** / **chopsticksAI-offline-v3.6.10.zip** from the product pages or [Releases](https://github.com/ilikemacos/ChopsticksAI/releases).
