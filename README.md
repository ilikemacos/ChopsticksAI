...
Latest release: **cs.AI Online 3.7.1** (Offline remains 3.6.10).
...
[![Download cs.AI 3.7.1](https://img.shields.io/badge/download-cs.AI%203.7.1-00ff80)](https://chopstickshq.com/chopsticks-ai/online/)
...
- Every plate is trained to be **smarter and faster**: lead with the answer, check numbers, skip filler
- **Kaji is alpha** and prone to wrong answers — labeled on web, Mac, and in Kaji’s own prompt
...
Or download **chopsticksAI-v3.7.1.zip** / **chopsticksAI-offline-v3.6.10.zip** from the product pages or [Releases](https://github.com/ilikemacos/ChopsticksAI/releases).
