...
Latest release: **cs.AI Online 3.7.8** (Offline remains 3.6.10).
...
[![Download cs.AI 3.7.8](https://img.shields.io/badge/download-cs.AI%203.7.8-00ff80)](https://chopstickshq.com/chopsticks-ai/online/)
...
- Sushi vs Sky plate names in Settings (and the web plate menu)
- Kaji Mac command sandbox: headless Alpine via Virtualization.framework
- 15pt type across Agents, Kaji, and web
...
Or download **chopsticksAI-v3.7.8.zip** / **chopsticksAI-offline-v3.6.10.zip** from the product pages or [Releases](https://github.com/ilikemacos/ChopsticksAI/releases).
