...
Latest release: **cs.AI Online 3.8.5** (Offline remains 3.6.10).
...
[![Download cs.AI 3.8.5](https://img.shields.io/badge/download-cs.AI%203.8.5-00ff80)](https://chopstickshq.com/chopsticks-ai/online/)
...
- Brazil: the Mac app shows the regional notice and does not send
...
Or download **chopsticksAI-v3.8.5.zip** / **chopsticksAI-offline-v3.6.10.zip** from the product pages or [Releases](https://github.com/ilikemacos/ChopsticksAI/releases).
