...
Latest release: **cs.AI Online 3.7.0** (Offline remains 3.6.10).
...
[![Download cs.AI 3.7.0](https://img.shields.io/badge/download-cs.AI%203.7.0-00ff80)](https://chopstickshq.com/chopsticks-ai/online/)
...
- **Kaji** is a first-class cs.AI Online app — Grok-style chat, HQ knowledge, web computer (no VM), Pro only
- Catchphrase: **Think different. Ask Kaji.**
- Web: [chopstickshq.com/chopsticks-ai/web/kaji/](https://chopstickshq.com/chopsticks-ai/web/kaji/)
...
Or download **chopsticksAI-v3.7.0.zip** / **chopsticksAI-offline-v3.6.10.zip** from the product pages or [Releases](https://github.com/ilikemacos/ChopsticksAI/releases).
