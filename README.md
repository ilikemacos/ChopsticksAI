...
Latest release: **cs.AI Online 4.1.0** (Offline remains 3.6.10).
...
[![Download cs.AI 4.1.0](https://img.shields.io/badge/download-cs.AI%204.1.0-00ff80)](https://chopstickshq.com/chopsticks-ai/online/)
...
- **cs.AI-4.0-Air** drafts on GLM 4.7 Flash free. GLM 5.2 free writes the final reply. No other models on Air.
...
Or download **chopsticksAI-v4.1.0.zip** / **chopsticksAI-offline-v3.6.10.zip** from the product pages or [Releases](https://github.com/ilikemacos/ChopsticksAI/releases).
