...
enum ChopsticksAIKB {
    ...
    static let intents: [ChopsticksAIIntent] = [
        ...
        ChopsticksAIIntent(
            ...
            priority: 70,
            answer: "ChopsticksAI for macOS is free.\n\n1. Download the App ZIP from chopstickshq.com/chopsticks-ai/ (currently v2.2.9a)\n2. Or run: curl -fsSL https://chopstickshq.com/chopsticks-ai/install-chopsticks-ai.sh | bash\n3. It installs to ~/Applications/chopsticksAI.app\n\nLive chat uses chopstickshq.com — no API key from you. Retrieval is keyword-scored plus Chromium search, not vector embeddings. If the network is down, product questions fall back to the on-device knowledge base.",
